...
function dm_the_thumbnail() {  
    ...
    echo '<img src="'.$thumbnailsrc.'" alt="'.trim(strip_tags( $post->post_title )).'" />';
        ...
        $n = count($strResult[1]);  
        if($n > 0){
            echo '<a href="'.get_permalink().'" class="pic"><img src="http://www.longsays.com/wp-content/uploads/timthumb.php?src='.$strResult[1][0].'&amp;w=140&amp;h=98&amp;zc=0&amp;f=1" alt="'.trim(strip_tags( $post->post_title )).'" /></a>';  
        }else {
